...
SECRET_KEY = 'django-insecure-ue77-zj06l%1(373cijg2jav1+g4g_l2a1f2j#!2h4+9x7e_n('
...
MIDDLEWARE = [
    ...
    'administrador.middleware.PlataformaMiddleware', # Middleware para la plataforma
]
